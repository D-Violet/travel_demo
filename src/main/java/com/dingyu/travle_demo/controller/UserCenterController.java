...
import com.dingyu.travle_demo.service.UserCenterService;
...
public class UserCenterController {
    ...
    public String centerUI(Model model, HttpServletRequest request) throws ServletException {
    ...
    public String centerEditUI(Model model, HttpServletRequest request) throws ServletException {
        User user = userCenterService.getUser(request);
        model.addAttribute("user", user);
    ...
    public Result centerEdit(Model model, User user) {
        return (Result) userCenterService.centerEdit(user);
    }

    @RequestMapping("/centerEditPWUI")
    public String centerEditPWUI(Model model, HttpServletRequest request) throws ServletException {
        User user = userCenterService.getUser(request);
    ...
    public Result centerEditPW(HttpServletRequest request, HttpServletResponse response, Model model, @RequestParam("id") String id, @RequestParam("oldPassword") String oldPassword, @RequestParam("newPassword") String newPassword) {
        return  (Result) userCenterService.centerEditPW(request, response, id, oldPassword, newPassword);
    }
}
